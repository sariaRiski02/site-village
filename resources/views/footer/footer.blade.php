<footer class="bg-[#071952] text-white pt-12 pb-3 rounded-t-2xl mt-3">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                ...
                <p class="text-gray-300 mb-4">Website resmi Pemerintah Desa Kema 3, Kecamatan Kema, Kabupaten Minahasa utara.</p>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('service') }}" class="text-gray-300 hover:text-white transition duration-300">service</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li class="flex items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-400 mr-2 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                        </svg>
                        <span class="text-gray-300">Jl. Raya Desa No. 123, Desa Kema 3</span>
                    </li>
                    <li class="flex items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-400 mr-2 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <li class="flex items-start">
                        ...
                        <span class="text-gray-300">info@desaKema 3.desa.id</span>
                    </li>
                </li>
                <li class="flex items-start">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-400 mr-2 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div>
            ...
            <div class="mt-4">
                ...
                <div class="flex space-x-3">
                    <a href="#" class="bg-blue-700 hover:bg-blue-600 h-8 w-8 rounded-full flex items-center justify-center transition duration-300">
    ...
    <div class="mt-2 pt-2 border-t border-blue-800 text-center">
        <p class="text-gray-400">&copy; created by <a href="https://mrizkysaria.netlify.app/" target="_blank"> rizky </a> & <a href="">Xing</a> Hak Cipta Dilindungi.</p>
    </div>
</div>
</footer>