            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-green-600 font-medium">Ketua BPD</p>
    ...
    <section id="layanan" class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-green-50 p-6 rounded-lg text-center hover:shadow-lg transition duration-300">
            ...
            <div class="bg-green-100 rounded-lg p-8 mt-12">
                <div class="flex flex-col md:flex-row items-center justify-between">
                    ...
                    <a href="#" class="mt-4 md:mt-0 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-semibold transition duration-300">Ajukan Permohonan</a>
                </div>
            </div>
        </div>
    </section>
