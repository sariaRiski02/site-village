...
<head>
    ...
    <title>Berita Desa Sejahtera</title>
...
<body class="font-sans bg-gray-100">
    ...
    <section class="py-12 bg-white">
        <div class="container mx-auto px-4">
            <div class="text-center mb-10">
                ...
                <p class="mt-4 text-gray-600">Informasi dan kegiatan terbaru di Desa Sejahtera</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden mb-10">
                <div class="md:flex">
                    ...
                    <div class="md:w-1/2 p-6">
                        <div class="text-green-700 text-sm font-bold mb-2">15 Maret 2025</div>
                        <h3 class="text-2xl font-bold text-gray-800 mb-4">Program Vaksinasi COVID-19 di Desa Sejahtera Mencapai 95% dari Target</h3>
                        <p class="text-gray-600 mb-6">Program vaksinasi COVID-19 di Desa Sejahtera telah berhasil mencapai 95% dari target. Keberhasilan ini merupakan hasil kerja sama yang baik antara pemerintah desa, tenaga kesehatan, dan partisipasi aktif warga desa.</p>
                        <a href="#" class="inline-block bg-green-700 text-white px-6 py-2 rounded-md hover:bg-green-800 transition duration-300">Baca Selengkapnya</a>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div class="p-6">
                        <div class="text-green-700 text-sm font-bold mb-2">10 Maret 2025</div>
                        ...
                        <a href="#" class="text-green-700 font-semibold hover:text-green-800">Baca Selengkapnya →</a>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div class="p-6">
                        <div class="text-green-700 text-sm font-bold mb-2">5 Maret 2025</div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div class="p-6">
                        <div class="text-green-700 text-sm font-bold mb-2">28 Februari 2025</div>
                        <h3 class="font-bold text-xl mb-2">BUMDES Baru Dibuka untuk Tingkatkan Ekonomi Desa</h3>
                        <p class="text-gray-600 mb-4">Badan Usaha Milik Desa (BUMDES) "Sejahtera Bersama" resmi dibuka. BUMDES ini akan fokus pada pengembangan produk-produk lokal.</p>
                        <a href="#" class="text-green-700 font-semibold hover:text-green-800">Baca Selengkapnya →</a>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div class="p-6">
                        <div class="text-green-700 text-sm font-bold mb-2">20 Februari 2025</div>
                        <h3 class="font-bold text-xl mb-2">Festival Budaya Tahunan Desa Sejahtera</h3>
                        <p class="text-gray-600 mb-4">Festival budaya tahunan Desa Sejahtera digelar dengan meriah. Acara ini menampilkan berbagai kesenian tradisional dan kuliner khas desa.</p>
                        <a href="#" class="text-green-700 font-semibold hover:text-green-800">Baca Selengkapnya →</a>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div class="p-6">
                        <div class="text-green-700 text-sm font-bold mb-2">15 Februari 2025</div>
                        <h3 class="font-bold text-xl mb-2">Program Beasiswa untuk Siswa Berprestasi</h3>
                        <p class="text-gray-600 mb-4">Pemerintah Desa Sejahtera meluncurkan program beasiswa untuk siswa berprestasi. Program ini akan membantu 10 siswa melanjutkan pendidikan ke jenjang yang lebih tinggi.</p>
                        <a href="#" class="text-green-700 font-semibold hover:text-green-800">Baca Selengkapnya →</a>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div class="p-6">
                        <div class="text-green-700 text-sm font-bold mb-2">10 Februari 2025</div>
                        <h3 class="font-bold text-xl mb-2">Renovasi Posyandu Desa Selesai Dilaksanakan</h3>
                        <p class="text-gray-600 mb-4">Renovasi Posyandu Desa Sejahtera telah selesai dilaksanakan. Fasilitas kesehatan ini dilengkapi dengan peralatan baru untuk meningkatkan kualitas layanan kesehatan.</p>
                        <a href="#" class="text-green-700 font-semibold hover:text-green-800">Baca Selengkapnya →</a>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-12 flex justify-center">
                <nav class="inline-flex rounded-md shadow">
                    ...
                    <a href="#" class="py-2 px-4 bg-green-700 border border-green-700 text-sm font-medium text-white">
                        2
                    </a>
                    <a href="#" class="py-2 px-4 bg-white border-t border-b border-gray-300 text-sm font-medium text-gray-700 hover:bg-gray-50">
                        3
    ...
    <section class="py-12 bg-green-700 text-white">
        <div class="container mx-auto px-4">
            <div class="max-w-xl mx-auto text-center">
                <h2 class="text-3xl font-bold mb-6">Dapatkan Berita Terbaru</h2>
                <p class="mb-8">Berlangganan newsletter kami untuk mendapatkan informasi terbaru seputar Desa Sejahtera langsung ke email Anda.</p>
                
                <form class="flex flex-col md:flex-row gap-4">
                    <input type="email" placeholder="Alamat Email Anda" class="flex-grow rounded-md px-4 py-3 text-gray-800 focus:outline-none">
                    <button type="submit" class="bg-green-900 hover:bg-green-800 text-white font-bold rounded-md px-6 py-3 transition duration-300">Berlangganan</button>
                </form>
                
                <p class="text-sm mt-4 text-green-200">Kami menghargai privasi Anda. Email Anda tidak akan disebarluaskan.</p>
            </div>
        </div>
    </section>
    ...
    <div class="fixed bottom-6 right-6 z-50">
        <button class="bg-green-700 hover:bg-green-800 text-white w-16 h-16 rounded-full shadow-lg flex items-center justify-center transition duration-300 focus:outline-none">
